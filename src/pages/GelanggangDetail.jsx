...
export default function GelanggangDetail() {
  ...
  // Note: we don't have a remove-user endpoint currently in backend mapped specifically for Gelanggang.
  // We'll simulate its logic or simply disable it if it doesn't exist yet, but for now we leave the UI scaffolding.
