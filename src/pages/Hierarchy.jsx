...
export default function Hierarchy() {
  ...
  return (
    <div className="h-full text-foreground p-4 md:p-8 pt-6">
      <div className="max-w-5xl mx-auto space-y-6 flex flex-col h-full lg:h-[calc(100vh-4rem)]">
        
        {/* Header */}
        <div className="flex items-center gap-4 shrink-0">
          <div>
            <h1 className="text-2xl md:text-3xl font-light tracking-tight">Network <span className="font-semibold">Hierarchy</span></h1>
        ...
        <div className="flex flex-col lg:flex-row gap-6 flex-1 min-h-0 overflow-y-auto lg:overflow-hidden">
          ...
          {/* Left Panel: Search */}
          <div className="w-full lg:w-1/3 flex flex-col gap-4 shadow-xl border border-border bg-card/40 rounded-xl p-4 shrink-0 max-h-[300px] lg:max-h-full">
          ...
          <div className="flex-1 border border-border bg-card/30 rounded-xl overflow-auto custom-scrollbar relative p-4 md:p-6 min-h-[400px]">
            {!selectedRoot ? (
